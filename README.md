...
### 2.1 Konsep Game
* **Genre**: Educational Game dengan tema Budaya Indonesia
* **Gameplay/Rule**: 
- Game bertemakan perang adat yang menggabungkan unsur matematika dan budaya Indonesia
- Pemain dapat memilih karakter dengan pakaian adat dari berbagai daerah
- Setiap pertarungan melibatkan pemecahan soal matematika
- Tingkat kesulitan soal disesuaikan dengan level kelas pemain (SMP)
...
- Pertarungan real-time antar pemain
...
- In-app purchase untuk mendapatkan koin tambahan
- Achievement system
...
4. Fitur Untuk menyimpan koin atau achievment yang didapatkan user setelah memenangkan game.
5. Fitur Untuk menyimpan koin top up yang dilakukan user melalui Google Play yaitu app in purchase.
6. Fitur Untuk menyimpan audio settings 
* **Konsep OOP**: 
...
* **Jenis Achievement**:
    1. Implementasi State Management ialah berupa save data Current character selection, Active achievements, Coin balance, dan Match history tanpa UI.
